...
package org.mixingloom.patcher
{
	...
	public class MigrateFunctionsPatcher extends AbstractPatcher {
		...
		public function MigrateFunctionsPatcher(className:String, propertyOrMethodName:String)
		{
		...
		private function openClass(swfTag: SwfTag):void
		{
			swfTag.tagBody.position = 4;
