...
package org.as3commons.bytecode.emit.impl {
	...
	public class AbcBuilder extends EventDispatcher implements IAbcBuilder {
		...
		public function reload(abc:AbcFile,newApplicationDomain:ApplicationDomain=null):void
		{
			/*_packageBuilders = new Dictionary();
			this._packageBuilders[0] = abc; 
			
			var abcFile:AbcFile = build(null);*/
			loader.loadAbcFile(abc, newApplicationDomain);			
		}
